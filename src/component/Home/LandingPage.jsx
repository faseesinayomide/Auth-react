...
const LandingPage  = () => {
  return (
    <div className='container'>
      <div className="flex py-20 flex-col sm:flex-col md:flex-col lg:flex-row justify-center items-center ">
        <div className="mb-[20%] sm:mb-8 md:mb-0 lg:mb-0 ">
          ...
          <div className="btn-group mt-10">
            <Link to="connect-wallet">
              <a
                href=""
                className="bg-yellow-500 px-9 hover:bg-yellow-400 py-2 rounded-3xl"
              >
                Resolve
              </a>
            </Link>
          ...
          <ul className="grid-list">
            <li>
              <div className="promo-card bg-gray">
                <RiPassValidLine className="text-6xl mb-3 text-yellow-400" />

                <h3 className=" font-semibold text-3xl mb-5">VALIDATION</h3>

                <Link to="/connect-wallet">
                  <span className="hover:text-yellow-500">Click here</span>
                </Link>
              </div>
            </li>
            ...
            <li>
              <div className="promo-card bg-gray ">
                <AiOutlineSetting className="text-6xl  mb-3 text-yellow-400 " />
            ...
            <li>
              <div className="promo-card bg-gray">
                <div className="">
                  <IoMdSwap className="text-6xl mb-3 text-yellow-400" />
                </div>
            ...
            <li>
              <div className="promo-card bg-gray">
                <div>
                  <PiCubeThin className="text-6xl mb-3 text-yellow-400" />
                </div>
            ...
            <li>
              <div className="promo-card bg-gray">
                <div className="">
                  <BiPurchaseTag className="text-6xl mb-3 text-yellow-400" />
                </div>
            ...
            <li>
              <div className="promo-card bg-gray">
                <div className="">
                  <TbArrowsTransferUp className="text-6xl mb-3 text-yellow-400" />
                </div>
            ...
            <li>
              <div className="promo-card bg-gray">
                <div className="">
                  <GiAutoRepair className="text-6xl mb-3 text-yellow-400" />
                </div>
            ...
            <li>
              <div className="promo-card bg-gray">
                <div className="">
                  <AiOutlineGift className="text-6xl mb-3 text-yellow-400" />
                </div>
            ...
            <li>
              <div className="promo-card bg-gray">
                <div className="">
                  <RiNftLine className="text-6xl mb-3 text-yellow-400" />
                </div>
